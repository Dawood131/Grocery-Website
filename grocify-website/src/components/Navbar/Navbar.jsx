  ...
  return (
    <header className={`bg-white fixed top-0 left-0 right-0 z-50 ${isScrolled ? "shadow-lg" : ""}`}>
      <nav className="max-w-screen-xl mx-auto px-6 sm:px-10 lg:px-20 md:h-[14vh] h-[12vh] flex justify-between items-center">
        {/* Logo */}
        <Link to="/" className="cursor-pointer text-3xl font-bold">
        ...
        <div className="flex items-center gap-x-3 mb-1">
          ...
          {localStorage.getItem("isAuthenticated") === "true" && (
            <button
              ...
              className="bg-gradient-to-b from-orange-400 to-orange-500 px-4 py-2 text-white text-lg rounded-lg hover:to-orange-600 hover:scale-102 ml-4 transition-all duration-200 cursor-pointer active:scale-100 hidden md:inline-block"
            >
              Sign Out
            </button>
          )}
        ...
        {/* Mobile Menu */}
        <ul
          className={`flex flex-col gap-y-6 p-8 bg-orange-500/18 backdrop-blur-xl rounded-2xl shadow-xl items-center md:hidden
        ...
        >
          ...
          {localStorage.getItem("isAuthenticated") === "true" && (
            <li>
              <button
                onClick={handleSignOut}
                className="bg-gradient-to-b from-orange-400 to-orange-500 px-4 py-2 text-white text-lg rounded-lg hover:to-orange-600 hover:scale-102 ml-4 transition-all duration-200 cursor-pointer active:scale-100"
              >
                Sign Out
              </button>
            </li>
